#!/usr/bin/perl
# GameTDB MD5 parser.
# Grabs a GameTDB XML file and converts it into a flat file
# There is a MD5 database for use with CubePlay's MD5 built-in verifier.
